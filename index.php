<?php
    ...
    if($_GET && isset($_GET["categorie"])) {
        ...
        $content .= "<div class='row col-md-9'>";
        ...
        while($produit = $r->fetch(PDO::FETCH_ASSOC)) {
            ...
            $content .= "<div class='col-md-4 pl-2 pr-2 pb-2'> <div class='card col-md-12' style='width: 18rem;'>
            <img style='cursor:pointer' class='card-img-top' src='$produit[photo]' alt='$produit[titre]' title='$produit[description]'>
                <div class='card-body'>
                    ...
                    <a href='fiche_produit.php?idProduit=$produit[id_produit]' class='d-flex justify-content-center btn btn-dark'>Voir le produit</a>
                </div>
            </div> </div>";
        }
