...
require_once("inc/init.php");
    ...
    if(isset($_POST["ajout_panier"])) {
        ...
        ////////////////////////////////////////////
        ajouter_produit_panier($_POST["id_produit"], $_POST["quantite"], $produit["prix"], $produit["titre"]);
    ...
    if(isset($_POST["ajout_panier"])) {
        ...
        for($i = 0; $i < count($_SESSION["panier"]["id_produit"]); $i++) {
            ...
            $content .= "<tr> <td colspan='4' style='text-align:right'> <strong> Montant Total : </strong> " . montantTotal() . " € </td> </tr>";
